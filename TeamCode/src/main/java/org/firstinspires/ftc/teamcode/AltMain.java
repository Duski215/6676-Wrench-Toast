...
//
//        while (motorLeftVert.isBusy()) {} // TODO: i shouldn't be stalling this, but i have to right now. fix it later
//
//        motorLeftVert.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
...
//removed negative from here
            ...
            //Removed negative from axial(8:10 AM, 9/30/24)
            ...
            /* should combine this with passover code for a single press to do the passover.
            This'll allow for a seamless passover and quicker cycle times
             */
