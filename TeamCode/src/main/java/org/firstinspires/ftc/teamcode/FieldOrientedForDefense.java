...
public class FieldOrientedForDefense extends LinearOpMode {
...
//            }
            ...
            motor0.setPower(leftFrontPower * power);
            motor2.setPower(rightFrontPower * power);
            motor1.setPower(leftBackPower * power);
            motor3.setPower(rightBackPower * power);
